...
upload_img = on_command("上传黑历史", aliases={"上传图库"}, priority=5, block=True, permission=PERM_EDIT)
show_list = on_command("黑历史统计", aliases={"图库统计"}, priority=5, block=True)
send_img = on_command("黑历史", priority=5, block=True)
delete_img = on_command("删除黑历史", aliases={"删除图库"}, priority=5, block=True, permission=SUPERUSER)
